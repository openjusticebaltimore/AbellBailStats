SELECT
  distinct_instances,
  instances AS total_instances,
  100 - round(distinct_instances::NUMERIC / instances*100, 1) AS percent_multiple,
  hwob_count,
...
FROM
  (
    SELECT
      COUNT(DISTINCT dscr_bail_events.case_number) AS distinct_instances,
